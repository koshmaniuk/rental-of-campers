...
import css from "./ListFavoritesSection.module.css";
...
const ListFavoritesSection = () => {
  ...
  const filteredCampers = filterCampers(favorites, filters);
...
export default ListFavoritesSection;
